...
for i in lista_patentes:
    ...
    try:
        vehiculo.set_Boletas(Cookies_Headers(vehiculo.get_Patente()).getBoletasVespucioNorte())
        vehiculo.get_Boletas()

    except:
        print('El vehiculo de patente', patente, 'no tiene boletas')
